...
interface SinglesMatchDetailsTableProps {
  match: MatchHistoryEntry;
  player1Color: string;
  player2Color: string;
}

export const SinglesMatchDetailsTable: React.FC<SinglesMatchDetailsTableProps> = ({
  match,
  player1Color,
  player2Color
}) => {
    ...
    <div className="overflow-hidden rounded-3xl border border-slate-800/50 shadow-2xl bg-black/40 backdrop-blur-3xl">
      <div className="w-full flex flex-col scrollbar-hide overflow-x-auto min-w-[400px]">
        ...
        <div className="flex items-center bg-slate-900/80 border-b-2 border-slate-800/50">
          ...
          <div className="flex px-[1vw] sm:px-[1.5vw] py-[1.5vh] sm:py-5 text-[2.5vw] sm:text-xs uppercase tracking-widest font-black text-slate-500 w-[24%] items-center">Breaker</div>
          <div className="flex px-[1vw] sm:px-[1.5vw] py-[1.5vh] sm:py-5 text-[2.5vw] sm:text-xs uppercase tracking-widest font-black text-slate-500 w-[24%] items-center">Winner</div>
        ...
        <div className="flex flex-col divide-y divide-slate-800/30">
          {match.frameDetails && match.frameDetails.length > 0 ? match.frameDetails.map((frame, fidx) => (
            <div key={fidx} className="flex items-center hover:bg-emerald-500/5 transition-colors group">
              ...
              <div className="flex px-[1vw] sm:px-5 py-[2vh] w-[24%] items-center overflow-hidden">
